  ...
  useEffect(() => {
    const checkFavorite = async () => {
      ...
      try {
        ...
        // Проверяем, есть ли наш медиа в списке избранных
        const isInFavorites = data.some((fav: any) => fav.mediaId === mediaIdString);
  ...
  const toggleFavorite = async () => {
    ...
    try {
      if (isFavorite) {
        ...
        await favoritesAPI.addFavorite(mediaIdString);
